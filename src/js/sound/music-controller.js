import * as TinyMusic from '../libs/tiny-music'

export default function MusicController() {

  this.playSong1 = function playSong1() {
    ...
    var sequence1 = new TinyMusic.Sequence(ac, tempo, lead)
    var sequence2 = new TinyMusic.Sequence(ac, tempo, harmony)
    var sequence3 = new TinyMusic.Sequence(ac, tempo, bass)
