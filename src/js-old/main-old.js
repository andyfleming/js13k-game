...
function update() {
  ...
  // TODO: only apply if timewarp still has "juice"
  if (key[CONFIG.KEY.TIMEWARP]) { ENEMY_TIME = 0.1 }

  // maybe this is where movement and states like "exploding" happen
  // (managing bounds happens within each, for both level edges and level geometry)
  // ignore_collide
  // ready_for_remove
